...
tanstackIntent:
  - id: "@reduxjs/toolkit#build-modern-redux-apps/modern-redux"
    run: "npx @tanstack/intent@latest load @reduxjs/toolkit#build-modern-redux-apps/modern-redux"
  ...
  - id: "@reduxjs/toolkit#build-modern-redux-apps/redux-dataflow"
    run: "npx @tanstack/intent@latest load @reduxjs/toolkit#build-modern-redux-apps/redux-dataflow"
  ...
  - id: "@reduxjs/toolkit#evolve-and-diagnose-redux-apps/debug-redux-toolkit-apps"
    run: "npx @tanstack/intent@latest load @reduxjs/toolkit#evolve-and-diagnose-redux-apps/debug-redux-toolkit-apps"
  ...
  - id: "@reduxjs/toolkit#evolve-and-diagnose-redux-apps/migrate-to-modern-redux"
    run: "npx @tanstack/intent@latest load @reduxjs/toolkit#evolve-and-diagnose-redux-apps/migrate-to-modern-redux"
  ...
  - id: "@reduxjs/toolkit#manage-server-data/adopt-rtk-query"
    run: "npx @tanstack/intent@latest load @reduxjs/toolkit#manage-server-data/adopt-rtk-query"
  ...
  - id: "@reduxjs/toolkit#model-redux-state/build-slices-and-selectors"
    run: "npx @tanstack/intent@latest load @reduxjs/toolkit#model-redux-state/build-slices-and-selectors"
  ...
  - id: "@reduxjs/toolkit#model-redux-state/design-state-ownership"
    run: "npx @tanstack/intent@latest load @reduxjs/toolkit#model-redux-state/design-state-ownership"
  ...
  - id: "@reduxjs/toolkit#orchestrate-side-effects/handle-side-effects"
    run: "npx @tanstack/intent@latest load @reduxjs/toolkit#orchestrate-side-effects/handle-side-effects"
